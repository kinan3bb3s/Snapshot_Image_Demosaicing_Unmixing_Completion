function [SMP_seq,FilterPattern_lst,SMP_seq_Ideal]=make_sampling_operators2(n1,n2,n3,num_obs_pxl,num_band,smp_scenario,SpectralProfiles)
% Last modification date: Jan 10 2022
% Modifier : Kinan ABBAS
% Modifications:
% a) Add photonfocus 5x5 patteren
% b) Remove the circutshifting of the patteren because it makes the
% patteren incosistent.
% c) Add the ideal filter to the result when the the real filter is
% selected
for tt=1:num_band
    tmp=(rand(1,num_band));
...
%     ptn1=[12    16     1    13    15     9     4     6    11    14     5     7     2     8     3    10];
    ptn1=[1,5,9,13,2,6,10,14,3,7,11,15,4,8,12,16];
%     ptn1=[1:16];
elseif num_band==25
...
SMP_seq_Ideal=zeros(n1,n2,num_band,num_obs_pxl);
for xx=1:n1
    for yy=1:n2
